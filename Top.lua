...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/hamoude313/Files_Top/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevTopW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTopW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTopW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTopW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevTopW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevTopW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevTopW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1617523013) then
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
...
--------------------------------------------------------------------------------------------------------------
function SourceTop(msg,data) -- بداية العمل
if msg then
...
SourceTopr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الكروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/XXV2V)'
end 
send(msg.chat_id_, msg.id_, SourceTopr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevTopW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevTopW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,Top_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevTopW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevTopW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevTopW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevTopW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevTopW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevTopW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevTopW(msg) then 
...
if text == 'تحديث السورس ❃' and DevTopW(msg) then 
os.execute('rm -rf Top.lua')
os.execute('wget https://raw.githubusercontent.com/hamoude313/Top/master/Top.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس توب\n ❃∫ الاصدار » { 1.3v}')
dofile('Top.lua')  
end
if text == 'الاصدار ❃' and DevTopW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس توب \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevTopW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/XXV2V) \n ❃∫ [قناه السورس](t.me/XXV2V)')
end
if text == "ضع اسم للبوت ❃" and DevTopW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevTopW(msg) then 
...
if text == 'المشتركين ❃' and DevTopW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevTopW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevTopW(msg) then
...
if text == ("قائمه العام ❃") and DevTopW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevTopW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevTopW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevTopW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevTopW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevTopW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevTopW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevTopW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevTopW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevTopW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..Topk..''..Top..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevTopW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevTopW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevTopW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevTopW(msg) then
...
local Top1_Msg = database:get(bot_id.."Top1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Top1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XXV2V')..') \n ❃∫ '..Top1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Top_Msg and not Special(msg) then  
local Top_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Top_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..Top_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/XXV2V)}\n ❃∫ ["..Top_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/XXV2V)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTopW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevTopW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevTopW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevTopW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevTopW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevTopW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevTopW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevTopW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevTopW(msg) then  
...
database:sadd(bot_id.."Top:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Top:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Top = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Top then 
names_Top = database:smembers(bot_id.."Top:blocname"..msg.chat_id_) or ""
if names_Top and names_Top[1] then 
for i=1,#names_Top do 
if name_Top:match("(.*)("..names_Top[i]..")(.*)") then 
...
database:set(bot_id.."Top:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Top:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Top:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Top:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Top:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Topa_new(Top1,Top2)
if Top2 and Top2.first_name_ then 
if Top2.first_name_:match("(.*)"..database:get(bot_id.."Top:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Top:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Top_nnn = database:get(bot_id.."Top:nump"..msg.chat_id_) or 5
local Top_nnn2 = database:get(bot_id.."Top:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Top_nnn2) == tonumber(Top_nnn) or tonumber(Top_nnn2) > tonumber(Top_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Top:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..Top2.username_.."](https://t.me/"..(Top2.username_ or "XXV2V")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Top:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(Top_nnn) - tonumber(Top_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Topa_new)
end
end
...
local TopChengName = database:get(bot_id.."Top:Cheng:Name"..data.id_)
if not data.first_name_ then 
if TopChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..TopChengName..']')
database:del(bot_id.."Top:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if TopChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Top:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local TopChengUserName = database:get(bot_id.."Top:Cheng:UserName"..data.id_)
if not data.username_ then 
if TopChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..TopChengUserName..']')
database:del(bot_id.."Top:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if TopChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Top:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local TopChengPhoto = database:get(bot_id.."Top:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if TopChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Top:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if TopChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Top:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
 ...
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
  ...
  ↬ . [DEVELOPER](t.me/XXV0V)       
   
  ↬ . [Information](t.me/XXV2V) 
...
if text == 'رفع نسخه الاحتياطيه' and DevTopW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XXV2V')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'XXV2V')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevTopW(msg) then    
dofile('Top.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevTopW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevTopW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevTopW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevTopW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevTopW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevTopW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevTopW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevTopW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevTopW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevTopW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevTopW(msg) then
...
if text == 'الملفات' and DevTopW(msg) then
t = ' ❃∫ ملفات السورس توب ↓\n≪━━━━━━TOP━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevTopW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/hamoude313/Files_Top/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات توب\n ❃∫ ملفات السورس ↓\n≪━━━━━━TOP━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━TOP━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس توب ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/XXV2V) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevTopW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/hamoude313/Files_Top/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Top.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس توب \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevTopW(msg) then
...
if text == "مسح الملفات" and DevTopW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevTopW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevTopW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XXV2V')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XXV2V')..')'
...
database:set(bot_id.."Top1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Top1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Top1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Top1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Top1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Top1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."Top1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Top1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Top1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Top1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."Top1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Top1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Top1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Top1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Top1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Top1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Top1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Top1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Top1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━TOP━━━━━━≫\n"
for k,v in pairs(list) do  
local Top_Msg = database:get(bot_id.."Top1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Top_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevTopW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevTopW(msg) then
...
if text == 'تفعيل الاذاعه' and DevTopW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevTopW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'توب').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'توب')
local Top_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..Top_Msg[math.random(#Top_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevTopW(msg) then 
...
if text == ("مسح ردود المطور") and DevTopW(msg) then 
...
if text == ("ردود المطور") and DevTopW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━TOP━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevTopW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevTopW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'توب').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevTopW(msg) then   
...
if text == 'تعطيل المغادره' and DevTopW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'XXV2V')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Topdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevTopW(msg) then
...
zh = https.request('https://rudi-dev.tk/Amir1/Top.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━TOP━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━TOP━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[TOP 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/XXV2V)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/Top.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/Top.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'توب')
...
Top = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Top)
...
------------------------------------------------------------------------
local TopAbot = database:get(bot_id.."Top1:Add:Filter:Rp2"..text..result.chat_id_)   
if TopAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..TopAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Top1_Msg = database:get(bot_id.."Top1:Add:Filter:Rp2"..text..result.chat_id_)   
if Top1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..Top1_Msg)
...
https.request('https://veer.saied.us/Top/request.php?insert='..JSON.encode(infos))
local list = database:smembers(bot_id.."User_Bot") 
for k,v in pairs(list) do 
